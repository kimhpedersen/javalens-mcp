...
class FrameworkProtocolIntegrationTest {
    ...
    void setUp() {
        ...
        toolRegistry.register(new GetJpaModelTool(() -> SessionContext.current().getJdtService()));
        toolRegistry.register(new GetHttpEndpointsTool(() -> SessionContext.current().getJdtService()));
